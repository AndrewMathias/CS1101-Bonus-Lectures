...
###TODO: 4.  Copy the following code into your main method and use the reformat code to clean it up quickly
            ...
            for(int i=1;i<=4*(5+4);i+=6){System.out.println("First Line");System.out.println(
                            "Second Line");for(int j=0;j<i/5;j++){System.out.println("SecondLoop");}int
                            somenumber=0;for(int y=9;y>1;y--){somenumber++;}System.out.println(somenumber);
